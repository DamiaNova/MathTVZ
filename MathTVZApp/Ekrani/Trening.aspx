    ...
    <form id="BodyFormTrening" runat="server">
        <div id="omotacTrening">
            ...
            <div>
                ...
                <asp:Button ID="btnKvizovi" runat="server" Text="Kreni" CssClass="btnKvizovi" OnClick="btnKvizovi_Click"/>
                <asp:Button ID="btnZadaci" runat="server" Text="Kreni" CssClass="btnZadaci" OnClick="btnZadaci_Click"/>
                <asp:Button ID="btnPripreme" runat="server" Text="Kreni" CssClass="btnPripreme" OnClick="btnPripreme_Click"/>
            </div>
        </div>
    </form>
